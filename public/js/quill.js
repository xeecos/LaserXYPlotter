...
/***/ function(module, exports, __webpack_require__) {
	...
	var _linespacing = __webpack_require__(109);
	...
	var STYLE_ATTRIBUTORS = [_align.AlignStyle, _background.BackgroundStyle, _color.ColorStyle, _direction.DirectionStyle, _linespacing.LineSpacingStyle, _font.FontStyle, _size.SizeStyle].reduce(function (memo, attr) {
	  memo[attr.keyName] = attr;
	  return memo;
	}, {});
...
/***/ function(module, exports, __webpack_require__) {
	...
	_core2.default.register({
	  ...
	  // 'attributors/attribute/linespacing': _linespacing.LineSpacingAttribute,

	  'attributors/class/align': _align.AlignClass,
	  'attributors/class/background': _background.BackgroundClass,
	  'attributors/class/color': _color.ColorClass,
	  'attributors/class/direction': _direction.DirectionClass,
	  'attributors/class/linespacing': _linespacing.LineSpacingClass,
	  ...
	  'attributors/style/linespacing': _linespacing.LineSpacingStyle,
	...
	_core2.default.register({
	  ...
	  'formats/linespacing': _linespacing.LineSpacingClass,
	      ...
	      this.pickers = selects.map(function (select) {
	        if (select.classList.contains('ql-align')) {
	          ...
	          if (select.querySelector('option') == null) {
	            ...
	            } else if (select.classList.contains('ql-linespacing')) {
	            	fillSelect(select, LINESPACINGS);
	          	}
	          }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.LineSpacingStyle = exports.LineSpacingClass = undefined;
	...
	var config = {
	  scope: _parchment2.default.Scope.INLINE,
	  whitelist: ['10px','14px', '18px', '24px', '32px', '64px']
	};

	// var LineSpacingAttribute = new _parchment2.default.Attributor.Attribute('linespacing', 'linespacing', config);
	var LineSpacingClass = new _parchment2.default.Attributor.Class('linespacing', 'ql-linespacing', {
		
	  scope: _parchment2.default.Scope.INLINE,
	  whitelist: ['s10px','s14px', 's18px', 's24px', 's32px', 's64px']
	});
	var LineSpacingStyle = new _parchment2.default.Attributor.Style('linespacing', 'line-height', config);

	// exports.LineSpacingAttribute = LineSpacingAttribute;
	exports.LineSpacingClass = LineSpacingClass;
	exports.LineSpacingStyle = LineSpacingStyle;
